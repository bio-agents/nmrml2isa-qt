...
## UI
from nmrml2isa_qt.qt.main import Ui_MainWindow

## UI MODULES
from nmrml2isa_qt.usermeta import UserMetaDialog
from nmrml2isa_qt.parserprogress import ParserProgressDialog
...
class MainWindow(QMainWindow):
    ...
    def checkArgs(self):
        ...
        if not inputDir:
            ...
            # list nmrML files in study folder
            if not [x for x in os.listdir(inputDir) if x[-5:].upper() == "NMRML"]:
                self.ui.lbl_input_error.setText("Directory contains no nmrML files")
                LEGIT = False
            else:
    ...
    def openHelp(self):
        rtd = "http://2isa.readthedocs.io/en/latest/nmrml2isa-qt/"
